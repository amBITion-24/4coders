...
const HeroSection = () => {
    ...
    return (
        <section {...settings} className="relative text-white text-center py-20 px-4 overflow-hidden min-h-screen">
            ...
            <div className="relative z-10 bg-none bg-opacity-50 h-full flex flex-col justify-center items-center">
                <h1
                    ...
                    className="text-4xl md:text-5xl lg:text-6xl font-extrabold animateanimated animatefadeInDown mb-6"
                >
                ...
                <p
                    ...
                    data-aos-duration='500'
                    data-aos-delay='100'
                    className="my-4 text-lg md:text-xl lg:text-2xl font-semibold animateanimated animatefadeInUp"
                >
                    A decentralised voting system that is built on ethereum blockchain
                </p>
